...
OUT_DIR = Path(__file__).resolve().parents[3] / "outputs" / "full_derivation" / "aec_new_region_cnn_surrogate_mimic_gate"
...
def main() -> None:
    ...
    g = load_dataset(DATA_DIR / "gangnam.xlsx")
    s = load_dataset(DATA_DIR / "sinchon.xlsx")
