...
TABLE_OUT_DIR = PROJECT_ROOT / "outputs" / "02_manuscript" / "table"
FIGURE_OUT_DIR = PROJECT_ROOT / "outputs" / "02_manuscript" / "figure"
...
def build_table5() -> pd.DataFrame:
    scanner = pd.read_csv(PROJECT_ROOT / "outputs" / "01_disease_logistic" / "scanner" / "scanner_subgroup_auc.csv")
...
SUPPLEMENTAL_DIR = PROJECT_ROOT / "outputs" / "02_manuscript" / "supplemental"
...
def plot_calibration(out_path: Path, n_bins: int = 5) -> None:
    preds = pd.read_csv(PROJECT_ROOT / "outputs" / "01_disease_logistic" / "logistic" / "predictions.csv")
