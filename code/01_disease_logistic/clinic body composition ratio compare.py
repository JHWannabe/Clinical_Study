...
# 전용 폴더를 따로 둔다
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "0907" / "clinic6_body_composition_ratio_compare"
...
# 실행하지 않고 outputs/0904/clinic6_body_composition_ratio_compare/logistic_regression_summary.csv의
