...
# 전용 폴더를 따로 둔다
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "0907" / "clinic8_all_ratio_compare"
...
# 실행하지 않고 outputs/0904/clinic8_all_ratio_compare/logistic_regression_summary.csv의 tuned_C/tuned_penalty
# 결과값을 그대로 옮겨왔다
...
MODEL_ORDER = ["clinic8", "clinic8_fpca3", "clinic8_uplow_ratio"]
MODEL_EXTRA_COLS = {
    "clinic8": [],
    "clinic8_fpca3": [],
...
DELONG_PAIRS = [
    ...
    ("clinic8_fpca3", "clinic8_uplow_ratio"),
]
MODEL_LABELS = {
    "clinic8": "clinic8",
    "clinic8_fpca3": "clinic8 + AEC FPCA(3)",
    "clinic8_uplow_ratio": "clinic8 + AEC Upper/Lower ratio",
}
FAMILIES = {
    "aec_compare": ["clinic8", "clinic8_fpca3", "clinic8_uplow_ratio"],
}
    ...
    for feat in valid_features:
        ...
        for model_name in MODEL_ORDER:
            ...
            if uses_aec:
                ...
                oof_proba = fpca_oof_proba(meta_int_m, aec_int_m, extra_cols, y_int, n_fpca, cv, logreg_params)
            else:
            ...
            input_cols = (["sex_M", "vendor_code", "age", "height", "weight", "kvp", "vatsat_ratio", "smi"]
                          + extra_cols + [f"fpca_pc{i}" for i in range(1, n_extra_aec + 1)])
