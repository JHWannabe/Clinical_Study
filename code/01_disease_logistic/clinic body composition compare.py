...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "0907" / "clinic7_body_composition_compare"
...
MODEL_ORDER = ["clinic7", "clinic7_fpca3", "clinic7_uplow_ratio"]
MODEL_EXTRA_COLS = {
    "clinic7": [],
    "clinic7_fpca3": [],
...
DELONG_PAIRS = [
    ...
    ("clinic7_fpca3", "clinic7_uplow_ratio"),
]
MODEL_LABELS = {
    "clinic7": "clinic7",
    "clinic7_fpca3": "clinic7 + AEC FPCA(3)",
    "clinic7_uplow_ratio": "clinic7 + AEC Upper/Lower ratio",
}
FAMILIES = {
    "aec_compare": ["clinic7", "clinic7_fpca3", "clinic7_uplow_ratio"],
}
    ...
    for feat in valid_features:
        ...
        for model_name in MODEL_ORDER:
            ...
            input_cols = (["sex_M", "age", "height", "weight", "vat", "sat", "smi"] + extra_cols
                          + [f"fpca_pc{i}" for i in range(1, n_extra_aec + 1)])
