...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "fusion_compare"

FUSION_DIRS = {
    "concat": PROJECT_ROOT / "outputs" / "fusion_concat",
    "gated": PROJECT_ROOT / "outputs" / "fusion_gated",
    "attnpool": PROJECT_ROOT / "outputs" / "fusion_attnpool",
    "crossattn": PROJECT_ROOT / "outputs" / "fusion_crossattn",
}
