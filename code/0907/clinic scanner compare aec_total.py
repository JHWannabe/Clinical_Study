...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "0907" / "clinic6_scanner_compare_aec_total"
...
# 실행하지 않고 outputs/0904/clinic_scanner_compare/logistic_regression_summary.csv의 tuned_C/tuned_penalty
# 결과값을 그대로 옮겨왔다
