...
# 전용 폴더를 따로 둔다
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "0907" / "clinic9_all_compare"
...
# 실행하지 않고 outputs/0904/clinic9_all_compare/logistic_regression_summary.csv의 tuned_C/tuned_penalty
# 결과값을 그대로 옮겨왔다
...
MODEL_ORDER = ["clinic9", "clinic9_fpca3", "clinic9_uplow_ratio"]
MODEL_EXTRA_COLS = {
    "clinic9": [],
    "clinic9_fpca3": [],
...
DELONG_PAIRS = [
    ...
    ("clinic9_fpca3", "clinic9_uplow_ratio"),
]
MODEL_LABELS = {
    "clinic9": "clinic9",
    "clinic9_fpca3": "clinic9 + AEC FPCA(3)",
    "clinic9_uplow_ratio": "clinic9 + AEC Upper/Lower ratio",
}
FAMILIES = {
    "aec_compare": ["clinic9", "clinic9_fpca3", "clinic9_uplow_ratio"],
}
